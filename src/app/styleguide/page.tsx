    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "40px 24px 120px", display: "flex", flexDirection: "column", gap: 44 }}>
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          <h1 style={{ fontSize: 30, fontWeight: 800, letterSpacing: "-0.035em", margin: 0 }}>Max — styleguide</h1>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{ fontFamily: "var(--font-jetbrains-mono)", fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-tertiary)" }}>
            Appearance
          </span>
          <ThemeToggle />
        </div>
      ...
      <Section title="SegmentedControl">
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <span style={{ fontSize: 13, width: 140 }}>Dark | Light</span>
            <ThemeToggle />
          </div>
        </div>
      </Section>

...
**1. A dynamic, forgiving data model — and effortless capture into it.** The **unit of meaning** is a week of living and what it cost, not a classified purchase. Transactions still matter enormously — they're the particles the week is made of, and merchant detail is what turns "you're above average" into "most of your shop is at M&S, and here's what that costs you" — but they are **never required to supply, and never wasted when supplied**. That single inversion removes the labeling tax structurally rather than cosmetically, because the tax was never about transactions existing; it was about the *user* being made to resolve them. **Capture is half of this pillar and is currently missing from what's built:** the interface must accept a spreadsheet, a statement, a screenshot, typed text, or speech, and Max maps it into the model itself — asking a short question when genuinely unsure, never handing back a queue of things to classify. Adding a week of data should feel like texting a friend. This is important enough to have its own document: see [The Data Model](../architecture/01-data-model.md).

...
| **C-3** | Build automated doctrine checks for the six mechanically-testable ones ([T-12](./principles/03-technical-principles.md)): banned vocabulary, one-question, provenance, suppression list, Article 9 filter, shared-core imports. Currently zero exist. | Agent, alongside V0 | Open |
